            ...
            <div>
                ...
                {this.state.errorStatus > 1 &&
                    <Modal isOpen={this.state.collapseForm} toggle={this.toggleForm}
                        ...
                        <ModalHeader toggle={this.toggleForm} className={styles.errorTitle}> Server side error
                            information: </ModalHeader>
                        <ModalBody>
                            <Row>
                                <Col xs="3"> Time: </Col> <Col xs="auto"
                                                               className={styles.errorText}>{this.state.error.timestamp} </Col>
                            </Row>
                            <Row>
                                <Col xs="3"> Resource : </Col> <Col xs="auto"
                                                                    className={styles.errorText}>{this.state.error.resource} </Col>
                            </Row>
                            <Row>
                                <Col xs="3"> Error : </Col> <Col xs="auto"
                                                                 className={styles.errorText}>{this.state.error.status} - {this.state.error.error} </Col>
                            </Row>
                            <Row>
                                <Col xs="3"> Message : </Col> <Col xs="auto"
                                                                   className={styles.errorText}>{this.state.error.message} </Col>
                            </Row>
                            <Row>
                                <Col xs="3"> Path : </Col> <Col xs="auto"
                                                                className={styles.errorText}>{this.state.error.path} </Col>
                            </Row>
                            <Row>
